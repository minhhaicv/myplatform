            ...
            var c = a(window),
                ...
                E = function(b) {
                    ...
                    if (c.length) {
                        ...
                        } else x[e] && x[e].call(this, h); if (-1 !== a.inArray(e, ["backColor", "foreColor"])) {
        ...
        w = function() {
            var b = function(a, b) {
                    var c = b.event,
                        ...
                        f = b.className,
                        g = b.dropdown;
                    return '<button type="button" class="btn btn-default btn-white btn-small' + (f ? " " + f : "") + (g ? " dropdown-toggle" : "") + '"' + (g ? ' data-toggle="dropdown"' : "") + (e ? ' title="' + e + '"' : "") + (c ? ' data-event="' + c + '"' : "") + (d ? " data-value='" + d + "'" : "") + ' tabindex="-1">' + a + (g ? ' <span class="caret"></span>' : "") + "</button>" + (g || "")
                },
                c = function(a, c) {
                    var d = '<i class="' + a + '"></i>';
                    return b(d, c)
